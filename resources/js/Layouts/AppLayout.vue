...
<template>
    ...
    <div class="bg-white shadow w-full p-2 flex items-center justify-between md:hidden">
        <div class="flex">

            <a href="{{ route('dashboard') }}" class="flex items-center">
                <h2 class="font-bold text-xl ml-2 hidden md:inline ">Cine</h2>
    ...
    <div class="flex">
        ...
        <div class="md:hidden flex items-center mx-2">
            <button id="menuBtn" class="rounded-full p-2 text-gray-900 bg-gray-200">
...
<div class="flex-1 flex flex-wrap ">
    <div class=" pl-2  bg-white text-gray-700 w-full md:w-auto  transform duration-300 flex flex-col md:flex hidden min-w-72 " id="sideNav">
